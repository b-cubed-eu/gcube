...
This outlines how to propose a change to gcube. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("b-cubed-eu/gcube", fork = TRUE)`.
...
Please note that the gcube project is released with a [Contributor Code
of Conduct](https://b-cubed-eu.github.io/gcube/CODE_OF_CONDUCT.md). By
